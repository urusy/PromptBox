...
export function toSearchParams(params: ImageSearchParams): URLSearchParams {
  ...
  if (params.min_rating != null) searchParams.set('min_rating', params.min_rating.toString())
  if (params.exact_rating != null) searchParams.set('exact_rating', params.exact_rating.toString())
  ...
  if (params.seed_tolerance != null)
    searchParams.set('seed_tolerance', params.seed_tolerance.toString())
